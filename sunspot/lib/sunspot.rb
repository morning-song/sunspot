...
module Sunspot
  ...
  class << self
    ...
    def new_more_like_this(...)
      session.new_more_like_this(...)
    end
    ...
    #
    delegate :delete_dirty?, to: :session
